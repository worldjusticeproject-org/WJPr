...
[`wjp_groupbars()`](https://worldjusticeproject-org.github.io/WJPr/reference/wjp_groupbars.md)
compares a percentage across demographic groups in separate facets. The
`target` column can be supplied as proportions (`0-1`) or percentages
(`0-100`); the function plots both on a 0-100 percentage scale.
