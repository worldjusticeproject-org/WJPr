...
|------------|------------------|------------------|
| `wjp_bars()` | target, grouping | colors, labels, lab_pos, order, show_legend |
| `wjp_dots()` | target, grouping, colors | order, sd, sample_size (for CI), show_legend |
| `wjp_lines()` | target, grouping | colors, labels, show_legend |
| `wjp_dumbbells()` | target, grouping, colors, cgroups | labels, labpos, label_offset, show_legend, order |
| `wjp_divbars()` | target, grouping, diverging | negative, labels, order, show_legend |
| `wjp_radar()` | target, axis_var, labels, colors | order, show_legend |
| `wjp_rose()` | target, grouping, labels | order |
| `wjp_slope()` | target, grouping | colors, labels, show_legend |
| `wjp_gauge()` | target, colors | labels, factor_order, show_legend |
| `wjp_lollipops()` | target, grouping | labels, order |
| `wjp_edgebars()` | target, grouping | labels, x_lab_pos |
| `wjp_groupbars()` | target, grouping, levels | labels, group_order, level_order, ci_lower + ci_upper or sd + sample_size (for CI), show_national + national_value, national_style, national_ci_lower + national_ci_upper, show_axis, label_position |
