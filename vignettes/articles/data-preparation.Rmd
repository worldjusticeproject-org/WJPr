...
| `wjp_lines()` | target, grouping | colors, labels |
| `wjp_dumbbells()` | target, grouping, colors, cgroups | labels, labpos, order |
| `wjp_divbars()` | target, grouping, diverging | negative, labels, order |
| `wjp_radar()` | target, axis_var, labels, colors | order |
| `wjp_rose()` | target, grouping, labels | order |
| `wjp_slope()` | target, grouping | colors, labels |
